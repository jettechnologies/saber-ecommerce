        ...
        <div className="flex justify-between w-full mt-4 gap-x-8 F">
            ...
            <div className="py-4 px-4 flex-1 border border-[#c0c0c0] rounded-md">
                <form id ="product-form" className="w-full">
                    ...
                    <div className="w-full">
                        <label htmlFor="discounts" className="text-size-400 text-text-black font-medium mb-3">
                            Discounts
                        </label>
                        <div className="mt-3">
                            <Select id = "discounts" name="discounts" className="border border-[#c0c0c0] text-medium text-sm w-full" select={[{key: "discounts", value: "Select discounts"}, {key: "electronics", value: "electronics"}, {key: "wearables", value: "wearables"}, {key: "gamings", value: "gamings"}, {key: "cameras", value: "cameras"}]}/>
                        </div>
                    </div>
                    <div className="w-full">
